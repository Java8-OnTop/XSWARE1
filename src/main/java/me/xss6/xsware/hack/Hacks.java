...
public final class Hacks implements Globals {
    ...
    public Hacks() {
        ...
        try {
            ArrayList<Class<?>> modClasses = ReflectionUtil.getClassesForPackage("me.xss6.xsware.hack.hacks");
    ...
    public final void onUnload() {
        ...
        this.hacks.forEach(XSWARE.EVENT_PROCESSOR::removeEventListener);

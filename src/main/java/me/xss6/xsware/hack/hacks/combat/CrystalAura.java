...
import me.xss6.xsware.hack.hacks.misc.AutoClip;
...
@Hack.Registration(name = "Crystal Aura", description = "epic", category = Hack.Category.COMBAT, priority = HackPriority.Highest)

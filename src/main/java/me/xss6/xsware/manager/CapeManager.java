...
import me.xss6.xsware.util.elements.Pair;
...
public class CapeManager implements Globals {
    ...
    public CapeManager() {
        ...
        try { // og
            URL capesList = new URL("https://raw.githubusercontent.com/XSS6-2b2t/XSS6/main/ogs.txt");
        ...
        try { // dev
            URL capesList = new URL("https://raw.githubusercontent.com/XSS6-2b2t/XSS6/main/dev.txt");
            BufferedReader in = new BufferedReader(new InputStreamReader(capesList.openStream()));
            String inputLine;
            while ((inputLine = in.readLine()) != null) {
        ...
        try { // cool dudes
            URL capesList = new URL("https://raw.githubusercontent.com/XSS6-2b2t/XSS6/main/cooldude.txt");
            BufferedReader in = new BufferedReader(new InputStreamReader(capesList.openStream()));
            String inputLine;
            while ((inputLine = in.readLine()) != null) {
        ...
        try { // donator
            File tmp = new File("XSWARE"+ File.separator + "capes");
            if (!tmp.exists()) {
                tmp.mkdirs();
            }
            URL capesList = new URL("https://raw.githubusercontent.com/XSS6-2b2t/XSS6/main/donator.txt");
            BufferedReader in = new BufferedReader(new InputStreamReader(capesList.openStream()));
            String inputLine;
            while ((inputLine = in.readLine()) != null) {
                ...
                URL capeUrl = new URL("https://raw.githubusercontent.com/XSS6/capes/" + cape + ".png");

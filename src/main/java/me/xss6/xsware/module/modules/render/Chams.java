...
import me.xss6.xsware.event.events.TotemPopEvent;
...
@Module.Registration(name = "Chams", description = "draws people as colours/through walls", category = Module.Category.RENDER, isListening = false)

...
import me.xss6.xsware.util.HoleUtil;
...
@Module.Registration(name = "Hole Blink", description = "walks to hole", category = Module.Category.COMBAT, priority = ModulePriority.High)
public class HoleBlink extends Module {
    ...
    public void onEnable() {
        ...
        if (target != null) {
            ...
            if (blink.getValue())
                XSWARE.Modules.enablehack("Blink");
    ...
    public void onDisable() {
        if (blink.getValue())
            XSWARE.Modules.disablehack("Blink");

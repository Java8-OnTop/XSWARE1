...
@Module.Registration(name = "Target Details", description = "shows status of dude", category = Module.Category.RENDER, isListening = false)
public class TargetDetails extends Module {
    ...
    private void getFuckedPlayers() {
        ...
        for (EntityPlayer player : mc.world.playerEntities) {
            if (player == mc.player || XSWARE.FRIEND_MANAGER.isFriend(player.getName()) || !EntityUtil.isLiving(player)) continue;

...
@Module.Registration(name = "Reverse Step", description = "pulls u down down down", category = Module.Category.MOVEMENT)
public class ReverseStep extends Module {
    ...
    public void onUpdate() {
        if (nullCheck()) return;
        try {
            if (mc.player.isInLava() || mc.player.isInWater() || mc.player.isOnLadder() || XSWARE.Modules.ishackEnabled("Speed")) return;

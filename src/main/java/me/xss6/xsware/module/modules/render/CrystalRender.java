...
import me.xss6.xsware.event.events.RenderEntityModelEvent;
...
@Module.Registration(name = "Crystal Render", description = "changes how crystal renders", category = Module.Category.RENDER, isListening = false)

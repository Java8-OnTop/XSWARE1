...
@Module.Registration(name = "Tracers", description = "drawslines", category = Module.Category.RENDER, isListening = false)
public class Tracers extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        mc.world.loadedEntityList.forEach(entity -> {
            ...
            if (!friends.getValue() && XSWARE.FRIEND_MANAGER.isFriend(player.getName())) return;
    ...
    public float[] getColorByDistance(Entity entity) {
        if (entity instanceof EntityPlayer && XSWARE.FRIEND_MANAGER.isFriend(entity.getName())) {

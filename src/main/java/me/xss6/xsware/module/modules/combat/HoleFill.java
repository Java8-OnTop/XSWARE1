...
@Module.Registration(name = "Hole Fill", description = "fills holes", category = Module.Category.COMBAT, priority = ModulePriority.Highest)
            ...
            for (BlockPos pos : new ArrayList<>(holes)) {
                ...
                if (!fillMode.is("Normal")) {
                    for (EntityPlayer target : mc.world.playerEntities) {
                        ...
                        if (XSWARE.FRIEND_MANAGER.isFriend(mc.player.getName())) continue;

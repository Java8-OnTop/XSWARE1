package me.xss6.xsware.module.modules.client;
...
@Module.Registration(name = "Gui", description = "swag custom gui", category = Module.Category.CLIENT, isListening = true, bind = Keyboard.KEY_RSHIFT)
public class Gui extends Module {
    ...
    public void onEnable(){
        mc.displayGuiScreen(XSWARE.GUI2);
        this.disable();
    }
}

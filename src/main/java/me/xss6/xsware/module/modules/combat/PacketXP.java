...
@Module.Registration(name = "Silent Xp", description = "uses exp with packets", category = Module.Category.COMBAT, priority = ModulePriority.Lowest)
public class PacketXP extends Module {
    ...
    private void usedXp(){
        ...
        if (allowTakeOff.getValue()) {
            takeArmorOff(); //TODO xss6 add the ArmourMend take off thing
        }
    }

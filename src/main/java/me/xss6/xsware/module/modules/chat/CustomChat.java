...
import me.xss6.xsware.gui.chat.GuiChat;
...
@Module.Registration(name = "Custom Chat", description = "lets you customise chat", category = Module.Category.CHAT, priority = ModulePriority.Low)

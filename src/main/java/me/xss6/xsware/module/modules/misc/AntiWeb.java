...
@Module.Registration(name = "Anti Web", description = "stops idiots from trapping you in webs", category = Module.Category.MISC, priority = ModulePriority.High)
public class AntiWeb extends Module {
    ...
    public void onUpdate(){
        if(nullCheck())return;
        if(mc.player.isInWeb && !XSWARE.Modules.ishackEnabled("Step")){

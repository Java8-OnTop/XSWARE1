...
import me.xss6.xsware.util.MappingUtil;
...
@Module.Registration(name = "Burrow", description = "fills ur lower-half with a block", category = Module.Category.COMBAT, priority = ModulePriority.Highest)

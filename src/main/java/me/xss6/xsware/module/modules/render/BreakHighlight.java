 ...
 * @author XSS6
 * @since 25/04/2021
 * fixed ur shit nerd ¬ xss6
 */

@Module.Registration(name = "Break Highlight", description = "highlights where people are breaking", category = Module.Category.RENDER, priority = ModulePriority.Lowest)

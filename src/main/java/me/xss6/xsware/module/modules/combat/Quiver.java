...
@Module.Registration(name = "Quiver", description = "shoots arrows like brr", category = Module.Category.COMBAT, isListening = false)
public class Quiver extends Module {
    ...
    public final void onUpdateWalkingPlayerEvent(@NotNull UpdateWalkingPlayerEvent event) {
        XSWARE.ROTATION_MANAGER.setPlayerPitch(-90);
    }

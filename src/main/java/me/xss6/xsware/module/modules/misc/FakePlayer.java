...
@Module.Registration(name = "Fake Player", description = "spawns a dripped out fake player", category = Module.Category.MISC, priority = ModulePriority.Lowest)
public class FakePlayer extends Module {
    ...
    public void onEnable() {
        ...
        EntityOtherPlayerMP clonedPlayer = new EntityOtherPlayerMP(mc.world, new GameProfile(UUID.fromString("dbc45ea7-e8bd-4a3e-8660-ac064ce58216"), "xss6"));

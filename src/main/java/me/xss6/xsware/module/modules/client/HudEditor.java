...
@Module.Registration(name = "Hud Editor", description = "swag custom Hud editor", category = Module.Category.CLIENT, isListening = true)
public class HudEditor extends Module {
    ...
    public void onEnable(){
        mc.displayGuiScreen(XSWARE.HUDGUI);
        this.disable();
    }
}

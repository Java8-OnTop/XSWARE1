...
public class HudArmor extends HudElement {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        while (listIterator.hasPrevious()) {
            ...
            HudUtil.drawHudString(s, x + 19 - 2 - XSWARE.GUI_FONT_MANAGER.getTextWidth(s), y + 7, 1677215);
            int dmg;
            ...
            HudUtil.drawHudString(dmg + "", (int) (x + 8 - XSWARE.GUI_FONT_MANAGER.getTextWidth(dmg + "") / 2f), y - 9, (new Color(red, green, 0)).getRGB());
        }

...
public class ColorComponent extends me.xss6.xsware.gui.component.Component {
    ...
    public void renderComponent(int mouseX, int mouseY) {
        RenderUtil2D.drawRectMC(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + XswareGuiNew.MODULE_OFFSET, parent.parent.getX() + XswareGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawRectMC(parent.parent.getX() + parent.parent.getWidth() - XswareGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + XswareGuiNew.MODULE_OFFSET, parent.parent.getX() + parent.parent.getWidth() - XswareGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawRectMC(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + XswareGuiNew.MODULE_OFFSET, parent.parent.getX() + parent.parent.getWidth() - XswareGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + XswareGuiNew.MODULE_OFFSET + 3, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawRectMC(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET, parent.parent.getX() + parent.parent.getWidth() - XswareGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET - 3, Gui.INSTANCE.buttonColor.getValue().hashCode());
        RenderUtil2D.drawBorderedRect(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET + 95, parent.parent.getY() + offset + XswareGuiNew.MODULE_OFFSET + 3, parent.parent.getX() + parent.parent.getWidth() - XswareGuiNew.SETTING_OFFSET - 5, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET - 3, 1, this.set.getValue().hashCode(), this.set.isChild() ? XswareGuiNew.GUI_CHILDBUTTON() : XswareGuiNew.GUI_COLOR(), false);
        if (Gui.INSTANCE.customFont.getValue()) {
            XSWARE.GUI_FONT_MANAGER.drawStringWithShadow(set.getName(), parent.parent.getX() + XswareGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 3 + XswareGuiNew.MODULE_OFFSET, Gui.INSTANCE.fontColor.getValue().hashCode());
        } else {
            Globals.mc.fontRenderer.drawStringWithShadow(set.getName(), parent.parent.getX() + XswareGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 3 + XswareGuiNew.MODULE_OFFSET, Gui.INSTANCE.fontColor.getValue().hashCode());
        }
        if (this.isOpen) {
            XswareGuiNew.drawRect(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + XswareGuiNew.MODULE_OFFSET + XswareGuiNew.HEIGHT, parent.parent.getX() + parent.parent.getWidth() - XswareGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET + booleanButtonOffset, this.set.isChild() ? XswareGuiNew.GUI_CHILDBUTTON() : XswareGuiNew.GUI_COLOR());
            ...
            RenderUtil2D.drawBorderedRect(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET + 85, parent.parent.getY() + offset + 4 + XswareGuiNew.MODULE_OFFSET + booleanButtonOffset, parent.parent.getX() + 115 - XswareGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET - 2  + booleanButtonOffset, 1,this.set.getRainbow() ? new Color(set.getValue().getRed(), set.getValue().getGreen(), set.getValue().getBlue(), 255).hashCode() : this.set.isChild() ? XswareGuiNew.GUI_CHILDBUTTON() : XswareGuiNew.GUI_COLOR(), new Color(0, 0, 0, 200).hashCode(), false);
            RenderUtil2D.drawRectMC(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET + (this.set.getRainbow() ? 95 : 88), parent.parent.getY() + offset + 6 + XswareGuiNew.MODULE_OFFSET + booleanButtonOffset, parent.parent.getX() + (this.set.getRainbow() ? 112 : 105) - XswareGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET - 4 + booleanButtonOffset, new Color(50, 50, 50, 255).hashCode());
            if (Gui.INSTANCE.customFont.getValue()) {
                XSWARE.GUI_FONT_MANAGER.drawStringWithShadow("Rainbow", parent.parent.getX() + XswareGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 5  + XswareGuiNew.MODULE_OFFSET + booleanButtonOffset , Gui.INSTANCE.fontColor.getValue().hashCode());
            } else {
                Globals.mc.fontRenderer.drawStringWithShadow("Rainbow", parent.parent.getX() + XswareGuiNew.SUB_FONT_SIZE, parent.parent.getY() + offset + 5  + XswareGuiNew.MODULE_OFFSET + booleanButtonOffset , Gui.INSTANCE.fontColor.getValue().hashCode());
            }
        }
    }
    ...
    public void renderToolTip(int mouseX, int mouseY){
        if(isMouseOnButton(mouseX, mouseY) && parent.isOpen && Gui.INSTANCE.toolTips.getValue()){
            ...
            int length = XSWARE.GUI_FONT_MANAGER.getTextWidth(text);
            ...
            XSWARE.GUI_FONT_MANAGER.drawStringWithShadow(text, mouseX + 3, mouseY + 8, new Color(255,255,255).hashCode());
        }
    }
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (isMouseOnButton(mouseX, mouseY) && parent.isOpen && button == 1) {
            for (me.xss6.xsware.gui.component.Component comp : parent.parent.getComponents()) {
                if (comp instanceof HackButton) {
                    if (((HackButton) comp).isOpen) {
                        for (me.xss6.xsware.gui.component.Component comp2 : ((HackButton) comp).getChildren()) {
        ...
        if(isMouseOnButton(mouseX, mouseY) && parent.isOpen && button == 0){
            XSWARE.GUI2.colorClipBoard = set.getValue();
        ...
        if(isMouseOnButton(mouseX, mouseY) && parent.isOpen && button == 2){
            this.set.setValue(XSWARE.GUI2.colorClipBoard);
        ...
        if (this.isOpen && firstTimeOpen) {
            ...
            for (Component component : this.parent.getChildren()) {
                ...
                if (flag) {
                    component.setOff(component.getOffset() + (XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET) * 5);
                }
            }
            this.firstTimeOpen = false;
        }
        if (this.isOpen && mouseOver(parent.parent.getX() + XswareGuiNew.SETTING_OFFSET + 85, parent.parent.getY() + offset + 4 + XswareGuiNew.MODULE_OFFSET + booleanButtonOffset, parent.parent.getX() + 115 - XswareGuiNew.SETTING_OFFSET, parent.parent.getY() + offset + XswareGuiNew.HEIGHT + XswareGuiNew.MODULE_OFFSET - 2  + booleanButtonOffset, mouseX, mouseY)) {
